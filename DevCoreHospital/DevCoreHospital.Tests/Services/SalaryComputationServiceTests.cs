...
public class SalaryComputationServiceTests
{
    ...
    public async Task ComputeSalaryDoctorAsync_ReturnsZero_WhenNoShifts()
    {
        ...
        repoMock.Setup(r => r.DidStaffParticipateInHangout(50, 5, 2026)).Returns(false);
    ...
    public async Task ComputeSalaryPharmacistAsync_ReturnsZero_WhenNoShifts()
    {
        ...
        repoMock.Setup(r => r.GetMedicinesSold(51, 5, 2026)).Returns(0);
        repoMock.Setup(r => r.DidStaffParticipateInHangout(51, 5, 2026)).Returns(false);
    ...
    public async Task ComputeSalaryPharmacistAsync_AppliesNoMedicineBonus_WhenZeroMedicinesSold()
    {
        ...
        repoMock.Setup(r => r.GetShiftHoursFromDb(8)).Returns(0);
        repoMock.Setup(r => r.GetMedicinesSold(52, 5, 2026)).Returns(0);
        repoMock.Setup(r => r.DidStaffParticipateInHangout(52, 5, 2026)).Returns(false);
